...
from ultralytics.utils.tal import dist2bbox, make_anchors, make_divisible

from repvit import RepVGGDW
...
class C2fFCIB(C2f):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, lk=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(FCIB(self.c, self.c, shortcut, e=1.0, lk=lk) for _ in range(n))
...
class CADown(nn.Module):
    ...
    def forward(self, x):
        ...
        x2 = self.cv2(x2)
        return self.atten(torch.cat((x1, x2), 1))
class DWCAA(nn.Module):
...
class C2fDWCAA(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(Bottleneck_DWCAA(self.c, self.c, shortcut, g, k=(3, 3), e=1.0) for _ in range(n))
